        ...
        <div class="content">
         ...
         <nav class="mb-2" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
              <li class="breadcrumb-item"><a href="applicant.php#!">My Job Posted</a></li>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="query.php">
                              ...
                              <input type="text" name="log" value="Admin  Active the work name <?= $rowwork1->workNAME; ?>" hidden>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="query.php">
                              <input type="text" name="workID" value="<?= $rowwork1->workID;?>" hidden>
                              <input type="text" name="log" value="Admin  disabled the work name <?= $rowwork1->workNAME; ?>" hidden>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="query.php">
                              <input type="text" name="workID" value="<?= $rowwork1->workID;?>" hidden>
                              <input type="text" name="log" value="Admin  delete the work name <?= $rowwork1->workNAME; ?>" hidden>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="post" action="query.php">
                              <input type="text" name="workID" value="<?= $rowwork1->workID;?>" hidden>
                              <input type="text" name="log" value="Admin  update the work name <?= $rowwork1->workNAME; ?>" hidden>
