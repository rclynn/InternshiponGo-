            ...
            <div class="row align-items-center justify-content-between g-3 mb-3">
              ...
              <div class="col-auto">
                <div class="d-flex align-items-center">
                 ...
                 <!--  <span class="fas fa-plus me-2" disabled></span>Add Students</button> -->
                </div>
              </div>
            </div>
...
$student=mysqli_query($con,"SELECT *  from student where status !='Deleted'")or die(mysqli_error($con));
