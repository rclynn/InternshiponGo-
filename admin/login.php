...
<?php 
if(isset($_SESSION['intershipgo_admin']))
{
//unset($_SESSION['cid']);
unset($_SESSION['intershipgo_admin']);
}
if(isset($_POST['btnlogin']))
    {
       ...
       $s = mysqli_query($con,"SELECT * FROM admin where adminPASSWORD  ='". $pass ."' and adminUSERNAME   = '". $user ."'") or die(mysqli_errno($con));
       $r = mysqli_fetch_object($s);
       $count=mysqli_num_rows($s);
       if($count>0){
        $_SESSION['intershipgo_admin']=$r->adminID;
