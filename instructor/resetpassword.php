                              ...
                              <div class="card text-dark bg-light">
                                <div class="card-body">
                                  ...
                                  <?php 
                                        ...
                                        $code=$_GET['code'];
                                        $student=mysqli_query($con,"SELECT * from instructor where instructorID = '$instructorID' and code ='$code'")or die(mysqli_error($con));
                                ...
                                if (!empty($rowstudent)) {
                                  ...
                                  ?>
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" name="instructorID" value="<?= $rowstudent->instructorID; ?>" hidden>
