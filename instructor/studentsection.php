...
//to select specific rows in the table
 if(isset($_GET['section']) ? $_GET['section'] : ''){
    ...
    $searchsection='Section '.$section;

 }else{
         echo"<script type='text/javascript'>window.location.replace('studentnew.php');</script>";
      }
?>
<!DOCTYPE html>
       ...
       <div class="content">
          <nav class="mb-2" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item ">Section <?php if ($section==1) { echo "A";}else if ($section==2) { echo "B"; }else if ($section==3) { echo "C"; }else if ($section==4) { echo "D"; }else if ($section==5) { echo "E"; }else if ($section==10) { echo "J"; }else if ($section==6) { echo "F"; }else if ($section==7) { echo "G"; }else if ($section==8) { echo "H"; }else if ($section==9) { echo "I"; }  ?></li>
            </ol>                    
...
date_default_timezone_set('Asia/Manila');
        ...
        // $year = date('Y',$time );
$year = date('Y');
$student=mysqli_query($con,"SELECT *  from student where colleges ='$rowadviser->instructorSCHOOL' and department='$rowadviser->instructorCOURSE' and classyear ='$year' and status !='Deleted' and section='$searchsection'")or die(mysqli_error($con));
