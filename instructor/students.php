              ...
              <div class="col-auto">
                <div class="d-flex align-items-center">
                 <!--  <form method="post" action="query.php">
                  <button class="btn btn-link text-900 me-4 px-0" type="submit" name="exportstudents"><span class="fas fa-cloud-download-alt fs--1 me-2"></span>Export</button>
                </form> -->
...
$student=mysqli_query($con,"SELECT *  from student where colleges ='$rowadviser->instructorSCHOOL' and department='$rowadviser->instructorCOURSE' and status !='Deleted'")or die(mysqli_error($con));
