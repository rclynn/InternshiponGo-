                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                              <div class="card text-dark bg-light">
                                <div class="card-body">
                                  ...
                                  <?php 
                                        $number=$_GET['number'];
                                        $instructor=mysqli_query($con,"SELECT * from instructor where instructorNUMBER = '$number'")or die(mysqli_error($con));
                                        $rowinstructor=mysqli_fetch_object($instructor);

                                        
                                if (!empty($rowinstructor)) {
                                        $securityQA=mysqli_query($con,"SELECT * from securityquestions where securityquestionsUSERID = '$rowinstructor->instructorID' and securityquestionsUSERTYPE = 'instructor'")or die(mysqli_error($con));
                                  ...
                                  ?>
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" name="instructorID" value="<?= $rowinstructor->instructorID; ?>" hidden>
