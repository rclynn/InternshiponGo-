       ...
       <div class="content">
          <nav class="mb-2" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
              <li class="breadcrumb-item active"><a href="members.html#!">Students</a></li>
              
            </ol>
          </nav>
          <h2 class="text-bold text-1100 mb-5">Students</h2>
          <div id="members" data-list='{"valueNames":["id","name","mobile_number","images","Coodinator","Course","Colleges","classyear"],"page":10,"pagination":true}'>
            <div class="row align-items-center justify-content-between g-3 mb-3">
              ...
              <div class="col-auto">
                <div class="d-flex align-items-center"><button class="btn btn-link text-900 me-4 px-0"><span class="fas fa-cloud-download-alt fs--1 me-2"></span>Export</button><button class="btn btn-primary"><span class="fas fa-plus me-2" disabled></span>Add Students</button></div>
              </div>
            </div>
                ...
                <table class="table table-sm fs--1 mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="sort align-middle  pe-0" scope="col" data-sort="C lleges" >School</th>
...
$student=mysqli_query($con,"SELECT *  from student where colleges ='$rowadviser->instructorSCHOOL' and department='$rowadviser->instructorCOURSE' ")or die(mysqli_error($con));
