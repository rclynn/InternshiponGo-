       ...
       <div class="content">
          <nav class="mb-2" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
              <li class="breadcrumb-item active"><a href="members.html#!">Instructor</a></li>
          ...
          <div id="members" data-list='{"valueNames":["id","name","mobile_number","images","Coodinator","Course","Colleges","section"],"page":10,"pagination":true}'>
            <div class="row align-items-center justify-content-between g-3 mb-3">
              ...
              <div class="col-auto">
                <div class="d-flex align-items-center"><button class="btn btn-link text-900 me-4 px-0"><span class="fas fa-cloud-download-alt fs--1 me-2"></span>Export</button><button class="btn btn-primary"><span class="fas fa-plus me-2" disabled></span>Add Instructor</button></div>
              </div>
            </div>
                ...
                <table class="table table-sm fs--1 mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="sort align-middle" scope="col" data-sort="id" >Instructor ID</th>
                      ...
                      <th class="sort align-middle pe-3" scope="col" data-sort="section" >Section Handle</th>
...
?>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="fs--1 align-middle ps-0 py-3">
                       ...
                       <td class="id align-middle white-space-nowrap"><a class="fw-semi-bold text-1100" href=""><?= $rowinstructor->instructorID;?></a></td>
                      ...
                      <td class="mobile_number align-middle white-space-nowrap"><a class="fw-semi-bold text-1100" href=""><?= $rowinstructor->instructorNUMBER;?></a></td>
                       <td class="section align-middle white-space-nowrap"><a class="fw-semi-bold text-1100" href=""><?= $rowinstructor->instructorSECTIONHANDLE;?></a></td>
